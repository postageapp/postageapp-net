...
namespace PostageApp.Http.Tests
{
    public class HttpPostageAppClient_GetAccountInfoAsyncShould
    {
        ...
        public async Task ReturnUnauthorizedGivenUnknownApiKey()
        {
            ...
            Assert.Equal(Abstractions.GetAccountInfoErrorCode.Unauthorized, result.Error.Value);
        ...
        public async Task ReturnLockedGivenLockedApiKey()
        {
            ...
            // Assert
            Assert.False(result.Succeeded);
            Assert.Equal(Abstractions.GetAccountInfoErrorCode.Locked, result.Error.Value);
